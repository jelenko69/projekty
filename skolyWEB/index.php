...
<div id="odkazy">
    ...
    <a href="" id="xxx">Kontakty</a>
    <a href="zeny.php" id="xxx">Ženy</a>
    <a href="muzi.php"id="xxx">Muži</a>
    <a href="index.php"id="xxx">Home</a>
...
<div id="vyberLista">
<div id="podklad">
    <a href="" id="vyberPrvky" >Trička<br>Košile</a> <br>
    <a href="" id="vyberPrvky">Mikiny <br>Svetry</a> <br>

    <a href="" id="vyberPrvky">Boty</a> <br> <br>
    <a href="" id="vyberPrvky" >Kalhoty<br>šortky</a>
...
$pripojeni->query("SET NAMES utf8");
    ...
    $vysledek=$pripojeni->query("select znacka.nazev_zn,znacka.id_zn,produkt.cena,produkt.pohlavi,produkt.popis,produkt.obrazek from produkt  join znacka on produkt.id_zn=znacka.id_zn  limit $start,$rpp");
