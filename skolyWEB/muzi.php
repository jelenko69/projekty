...
$pripojeni->query("SET NAMES utf8");
    ...
    $vysledek=$pripojeni->query("select znacka.nazev_zn,znacka.id_zn,produkt.cena,produkt.pohlavi,produkt.popis,produkt.obrazek from produkt  join znacka on produkt.id_zn=znacka.id_zn where produkt.pohlavi='M' limit $start,$rpp");
